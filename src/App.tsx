...
export default function App() {
  ...
  const baseShape = useMemo(() => {
    switch (shapeType) {
      ...
      case 'torus': return generateTorus(params.detail * 2, params.detail, params.radius, params.radius * 0.4);
      case 'tunnel': return generateTunnel(params.detail, params.radius, params.radius * 4);
      case 'particles': return generateParticles(params.particleCount, params.radius);
      case 'cubes': return generateCubeGrid(params.radius * 0.4, params.radius * 0.6);
      case 'burst': return generateBurst(params.detail * 10, params.radius);
      default: return generateSphere(params.detail, params.detail * 2, params.radius);
    }
  }, [shapeType, params.radius, params.detail, params.particleCount]);
        ...
        <div className="p-6 space-y-8 flex-1">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              {['sphere', 'torus', 'tunnel', 'particles', 'cubes', 'burst'].map(type => (
                <button
                  key={type}
